...
import { LatestDataCard } from '@/components/cards/LatestDataCard';
    ...
    <div className="min-h-screen max-w-full mx-auto bg-slate-50 text-slate-950 flex flex-col items-center">
      ...
      <main className="w-full">
        <Container className="mb-8 flex flex-col items-center">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 w-full">
            <SoilCard data={data} />
        ...
        <Container className="mb-8">
          <div className="w-full">
            <LatestDataCard data={data} loading={loading} />
          </div>
        </Container>
